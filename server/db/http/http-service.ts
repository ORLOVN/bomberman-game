...
export default class Http {
    ...
    public get<T>(url: string, data?: Record<string, unknown>, options?: RequestInit): Promise<T> {
    ...
    public put<T>(url: string, data?: IFormData, options?: RequestInit): Promise<T> {
        return this.request<T>(url, data, options, Methods.PUT);
    }

    public post<T>(url: string, data?: IFormData, options?: RequestInit): Promise<T> {
